...
import { Row, Button, Form, FormControl, Nav, Navbar, NavDropdown } from 'react-bootstrap';
...
var Revalidation = /** @class */ (function (_super) {
    ...
    Revalidation.prototype.getCarouselData = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, getListItems(carouselList, "*", "").then(function (result) {
    ...
    Revalidation.prototype.componentDidMount = function () {
        var promise = this.getCarouselData();
    };
        ...
        return (React.createElement("section", null,
            React.createElement(Row, null,
                React.createElement(Navbar, { bg: "light", expand: "lg" },
                    React.createElement(Navbar.Brand, { href: "#home" }, "React-Bootstrap"),
                    ...
                    React.createElement(Navbar.Collapse, { id: "basic-navbar-nav" },
                        React.createElement(Nav, { className: "mr-auto" },
                            ...
                            React.createElement(Nav.Link, { href: "#link" }, "Link"),
            ...
            React.createElement(Row, null,
                React.createElement(CarouselComponent, { carouselData: this.state.carouselData }))));
    };
    return Revalidation;
}(React.Component));
